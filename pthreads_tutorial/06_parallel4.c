/*
    Step 5: Eliminate Lock Contention: We were basically doing all the work sequentially.
    And, adding the overhead of locking and unlocking one global lock variable.
    Each thread should perform local addition parallely, then synchronize final updates.
    Let's fix this!
